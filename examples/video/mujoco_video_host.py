"""Run host-side signaling/media service with a MuJoCo simulation camera source."""
...
def _parse_args() -> argparse.Namespace:
    ...
    parser.add_argument("--mj-model", required=True, help="Path to MuJoCo XML model.")
    parser.add_argument(
        "--mj-camera",
        default=None,
        help="MuJoCo camera name or id string.",
    )
